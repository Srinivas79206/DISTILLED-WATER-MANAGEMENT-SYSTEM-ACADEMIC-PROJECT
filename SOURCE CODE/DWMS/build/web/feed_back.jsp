...
<html lang="en">
    ...
    String tid = request.getParameter("transporter_id");
          %>
          <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Feedback Form</h1>
                                        </div>
                                        <form class="user" action="feed.jsp" method="get">
                                            <div class="form-group">
                                                <input type="hidden" value="<%=oid%>" name="oid">
                                                <input type="hidden" value="<%=tid%>" name="tid">
                                            </div>
                                            <div class="form-group">
                                                <textarea  name="des" class="form-control form-control-user" id="exampleInputPassword" placeholder="Feed Back"></textarea>
                                            </div>
                                            <div class="form-group">

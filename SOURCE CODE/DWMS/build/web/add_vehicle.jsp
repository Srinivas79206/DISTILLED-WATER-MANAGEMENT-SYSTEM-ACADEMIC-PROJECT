          ...
          <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="add_vehicle1.jsp" method="get">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="vname" aria-describedby="emailHelp" required="" placeholder="Enter Vehicle Name">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="v_size" class="form-control form-control-user" id="exampleInputPassword" placeholder="Vehicle Size" required="">
                                            </div>
                                            <div class="form-group">
